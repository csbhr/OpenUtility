...
ori_root = '/home/csbhr/workspace/deblur_result/experiment/testIterate_PWC_Mask_SRN_Video_Deblur_filter/result/DEEP_VIDEO_DEBLURRING'
dest_root = '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/ours_intermediate_result/GOPRO/ours_train_GOPRO/mask'
...
ori_root = '/home/csbhr/workspace/deblur_result/experiment/testIterate_PWC_Mask_SRN_Video_Deblur_filter/result/DEEP_VIDEO_DEBLURRING'
dest_root = '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/intermediate_result/GOPRO/ours_train_GOPRO/flow'
...
root_list = [
    {
        'ori': '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/intermediate_result/GOPRO/ours_train_GOPRO/flow',
        'dest': '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/ours_intermediate_result/GOPRO/ours_train_GOPRO/flow'
    },
    {
        'ori': '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/intermediate_result/GOPRO/iterate_mask/flow',
        'dest': '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/ours_intermediate_result/GOPRO/iterate_mask/flow'
    },
    {
        'ori': '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/intermediate_result/GOPRO/iterate/flow',
        'dest': '/media/csbhr/1_Disk2T/BHR/Video_Deblur_Results/ours_intermediate_result/GOPRO/iterate/flow'
    },
]
